  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        <a class="btn btn-outline-success d-block my-sm-1" href="login.php">Button1</a>
        <a class="btn btn-outline-success d-block my-sm-1" href="register.php">Button2</a>
        <a class="btn btn-outline-success d-block my-sm-1" href="login.php">Button3</a>
        <a class="btn btn-outline-success d-block my-sm-1" href="register.php">Button4</a>
      </div>
